...
/* Define function that is used to determine whether any symbol
   is operator or not(that is symbol is operand)

   is_operator(char symbol): this fucntion returns 1 if symbol is
...
/* infix to postfix conversion funciton*/
